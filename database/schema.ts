...
export class CategoryGroupSchema extends BaseModel {
  static $columns = ['archived', 'archivedAt', 'id', 'name', 'position', 'updatedAt', 'userId'] as const
...
export class SettingSchema extends BaseModel {
  static $columns = ['createdAt', 'currency', 'id', 'locale', 'localeInitializedAt', 'timezone', 'updatedAt', 'userId'] as const
